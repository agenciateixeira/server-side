/**
 * GTX - Sync QUALIFIED Leads to Meta CAPI
 *
 * Este script busca leads QUALIFICADOS no Supabase
 * e envia evento "SubmitApplication" para Meta CAPI
 *
 * Executar: node scripts/sync-qualified-to-meta.js
 */
...
const CONFIG = {
  ...
  filters: {
    ...
    statusFilter: ['qualificado', 'reuniao_agendada'], // Vazio = envia todos os status
